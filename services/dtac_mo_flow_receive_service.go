...
func DtacMoFlowReceiveProcessRequest(partner_id string, refid string, adsid string, client_ip string) map[string]string {
	...
	redis_key := "DTAC-MO:" + partner_id + ":" + transaction_id
	ttl := 240 * time.Hour // expires in 240 Hour
	// Set key with TTL
	...
	var cacheClientService cacheRedisData
